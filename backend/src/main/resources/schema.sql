-- PetLifePlus schema  (idempotent — safe to run on a fresh database)
-- spring.sql.init.mode=never のため自動適用されません。
-- 新規セットアップ時:  psql -U postgres -d petlifeplus -f schema.sql
